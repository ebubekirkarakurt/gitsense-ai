...
export default function Home() {
  ...
  const [suggestions, setSuggestions] = useState<{ message: string; description: string }[]>([]);
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", height: "100vh" }}>
      ...
      {/* Ana içerik */}
      <div style={{ flex: 1, overflow: "auto", display: "flex", gap: 32, padding: "40px 48px 120px" }}>
        ...
        <div style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column" }}>
          ...
          {isEmpty ? (
            ...
            <div style={{
              ...
              <h1 style={{ fontSize: 28, fontWeight: 600, color: "var(--color-text)", marginBottom: 8 }}>
                Merhaba Bekir 👋
              </h1>
            ...
            <>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 24 }}>
                ...
                {suggestions.length > 0 && (
                  <button
                    onClick={() => {
                      const allCommits = suggestions.map(s => s.message).join("\n");
              ...
              {diff && (
                <div style={{ marginBottom: 12 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
                    <h2 style={{ fontSize: 15, fontWeight: 600, color: "var(--color-text)" }}>Git Diff</h2>
                    <button
                      onClick={() => { setDiff(""); setSuggestions([]); setStats(null); }}
                      style={{ background: "none", border: "none", fontSize: 12, color: "var(--color-muted)", cursor: "pointer" }}
                    >
                      ✕ Clear
                    </button>
                  </div>
                    ...
                    {suggestions.map((suggestion, index) => (
                      <div key={index} style={{
                        ...
                        <div style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                          ...
                          <div>
                            <code style={{ fontSize: 13, color: "var(--color-text)", fontFamily: "monospace", display: "block" }}>
                              {suggestion.message}
                            </code>
        ...
        {!isEmpty && (
          <div style={{ width: 240, flexShrink: 0, display: "flex", flexDirection: "column", gap: 24, paddingTop: 8 }}>
            <div>
